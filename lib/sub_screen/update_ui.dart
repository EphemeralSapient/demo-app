        ...
        body: Center(
          child: Column(
            ...
            children: [
              ...
              global.padHeight(80),
              global.textWidget("OTA Status : ${currentEvent?.status.toString() ?? 'NULL'}"),
              global.padHeight(20),
              global.textWidget(trigger == false ? "Percentage completed : ${currentEvent?.value ?? 'NULL'}" : "${currentEvent?.value ?? 'NULL'} | Auto closing in 5 seconds")
            ],
          )
        ),
      ),

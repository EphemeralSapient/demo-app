...
void promptViewLeaveForms() {
  Widget which = global.accountType == 2 ? viewLeaveStudent() : viewLeaveFaculty();
                            ...
                            children: [
                              ExpansionPanel(
                                ...
                                headerBuilder:(context, isExpanded) {
                                  return isExpanded==false ? Padding(
                                ...
                                body: Padding(
                                  padding: const EdgeInsets.only(bottom:15.0,left:15,right:5),
                                  child: Column(
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                      Padding(
                                        ...
                                        child: Row(
                                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                          children: [
                                            global.textDoubleSpanWiget("Start Date : ", DateFormat("dd-MM-yyyy").format(x["startDate"].toDate())),
                                            global.textDoubleSpanWiget("End Date : ", DateFormat("dd-MM-yyyy").format(x["endDate"].toDate())),
                                          ],
                                        ),
                                      ),
                                      ...
                                      global.textDoubleSpanWiget("Reason : ", x["reason"]),
                                      ...
                                      Padding(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            InkWell(
                                              onTap: () {
                                                global.alert.quickAlert(context, global.textWidget("Not implemented yet"));
                                              },
                                              child: 
                                              Padding(
                                                padding: const EdgeInsets.all(8.0),
  ...
  void update([Function? fn]) {
    ...
    Future.delayed(Duration(), () async {
      ...
      for(var x in get.docs) {
        ...
        if(getData["tutor"] == selfId && getData["tutorApproval"] == "Not yet"){
          canAdd = true;
                                  ...
                                  return isExpanded==false ? Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        global.textWidget("${x["year"].toString().toUpperCase()} ${x["department"].toString().toUpperCase()} ${x["section"].toString().toUpperCase()}")
                                      ],
                                    ),
                                  )
                                  :
                                ...
                                body: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      global.textDoubleSpanWiget("Name of student : ", x["name"]),
                                      ...
                                      Padding(
                                        ...
                                        child: Row(
                                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                          children: [
                                            global.textDoubleSpanWiget("Department & Year : ", "${x["department"].toString().toUpperCase()} - ${x["year"].toString().toUpperCase()}"),
                                            global.textDoubleSpanWiget("Section : ", x["section"].toString().toUpperCase()),
                                          ],
                                        ),
                                      ),
                                      ...
                                      global.textWidgetWithHeavyFont("Approval will be signed as ${x["requestingAs"].toString().toUpperCase()}"),
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            InkWell(
                                              onTap: () {
                                                update(() async {
                                                  dupPending[x["index"]]["${x['requestingAs'].toString()}Approval"] = Timestamp.now();
                                                  Map<String, Object> newMap = {};
                                                  for(var a in (dupPending[x["index"]]).entries) {
                                                    newMap[a.key.toString()] = a.value;
                                                  }
                                                  var update = await global.Database!.update(global.collectionMap["leaveForms"]!, x["id"], newMap);

                                                  var result = "Successfully updated [approved] the form";
                                                  if(update.status == db_fetch_status.success) {
                                                    debugPrint("Updated ${x["id"]}");
                                                  } else {
                                                    result = "Error occurred, ${update.data.toString()}";
                                                  }

                                                  ScaffoldMessenger.of(buildContext).showSnackBar(SnackBar(content: Text(result),));
                                                });
                                              },
                                              child: 
                                              Padding(
                                            ...
                                            InkWell(
                                              onTap: () {
                                                update(() async {
                                                  var delete = await global.Database!.remove(global.collectionMap["leaveForms"]!, x["id"]);

                                                  var result = "Successfully deleted the form";
                                                  if(delete.status == db_fetch_status.success) {
                                                    debugPrint("Removed ${x["id"]}");
                                                  } else {
                                                    result = "Error occurred, ${delete.data.toString()}";
                                                  }

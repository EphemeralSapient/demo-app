...
void route(type){
  if(type == 1) {
    Navigator.push(global.choiceRouteCTX!,CupertinoPageRoute(builder: (context) => const staffLogin()));
    
  } else if(type == 2){
    Navigator.push(global.choiceRouteCTX!, CupertinoPageRoute(builder: (context) => const studentLogin()));
  } else if(type == 3){

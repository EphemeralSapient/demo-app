...
class StaffLoginImpl extends State<staffLogin> {
  ...
  void initState(){
    super.initState();
    //emailController.text = "@drngpit.ac.in";
  }
              ...
              children: [
                TextFormField(
                  ...
                  validator: (value) {
                    ...
                    if (value!=null && !RegExp("^[a-zA-Z0-9+_.-]+@drngpit.ac.in").hasMatch(value)) {
                      return ("Please Enter a valid gmail suffix to @drngpit.ac.in");
                    }
                    return null;
                  },

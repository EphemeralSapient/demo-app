...
class studentLogin extends StatelessWidget {
  ...
  Future<String?> _authUser(LoginData data) {
    ...
    return Future.delayed(const Duration(milliseconds: 1000)).then((_) async {
      ...
      try {
        UserCredential response = await FirebaseAuth.instance.signInWithEmailAndPassword(email: data.name, password: data.password);
      ...
      loginProviders: <LoginProvider>[
        LoginProvider(
          ...
          callback: () async {
            ...
            try{ acc = await sign_in.signIn(); } on Exception catch(e){
            ...
            //if(!RegExp("^[a-zA-Z0-9+_.-]+@drngpit.ac.in").hasMatch(acc.email)) return "Please use your official college email ID";
